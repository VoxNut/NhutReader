...
import com.nhut.hoshi.features.settings.SettingsLoadState
import com.nhut.hoshi.features.settings.collectAsSettingsLoadState
import com.nhut.hoshi.features.storage.StorageCleanupCategoryId
import com.nhut.hoshi.features.storage.StorageCleanupReport
import java.io.File
            ...
            item {
                AboutCard {
                    ListItem(
                        ...
                        headlineContent = { Text("Nhut Reader") },
                        supportingContent = {
                            Text(
                                stringResource(
            ...
            item {
                AboutCard {
                    Column(Modifier.padding(16.dp)) {
                        ...
                        Text(
                            text = "Vo Minh Nhut (nhut)",
                            style = MaterialTheme.typography.bodyLarge,
                            color = MaterialTheme.colorScheme.onSurface,
                        )
                        Spacer(Modifier.height(4.dp))
                        Text(
                            text = "Personal translation and reading companion app.",
