...
import com.nhut.hoshi.ui.asString
        ...
        LazyColumn(
            ...
            item {
                AnkiCard {
                    ListItem(
                        ...
                        headlineContent = { Text(stringResource(R.string.anki_history_row_label)) },
                        supportingContent = { Text(stringResource(R.string.anki_history_row_description)) },
                        trailingContent = {
                            Icon(
            ...
            item {
                AnkiCard {
                    ...
                    AnkiDivider()
                    AnkiSwitchRow(
                        label = stringResource(R.string.anki_ai_translate_sentence),
                        supportingText = stringResource(R.string.anki_ai_translate_sentence_description),
                        checked = uiState.settings.aiTranslateSentence,
                        onCheckedChange = viewModel::updateAiTranslateSentence,
                    )
                    if (uiState.settings.aiTranslateSentence) {
                        AnkiDivider()
                        AnkiTextValueRow(
                            label = stringResource(R.string.anki_ai_translate_field),
                            value = uiState.settings.aiTranslateField,
                            onValueChange = viewModel::updateAiTranslateField,
                            dialogLabel = stringResource(R.string.anki_ai_translate_field_description),
                        )
                    }
                }
            }
