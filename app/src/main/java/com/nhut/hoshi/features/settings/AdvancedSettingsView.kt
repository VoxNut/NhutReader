...
import com.nhut.hoshi.features.anki.AnkiConnectView
import com.nhut.hoshi.features.audio.AudioSettingsView
import com.nhut.hoshi.features.backup.BackupSettingsView
import com.nhut.hoshi.features.firebase.FirebaseSettingsView
import com.nhut.hoshi.features.reader.ReaderSettings
import com.nhut.hoshi.features.reader.ReaderStatisticsSettingsView
import com.nhut.hoshi.features.sasayaki.SasayakiSettingsView
import com.nhut.hoshi.features.sync.SyncSettingsView
import com.nhut.hoshi.features.translation.GeminiTranslationSettingsView
...
fun AdvancedSettingsView(
    ...
    if (destination == AdvancedDestination.GeminiTranslation) {
        GeminiTranslationSettingsView(
            onClose = { destination = null },
            modifier = modifier,
        )
        return
    }
    if (destination == AdvancedDestination.Firebase) {
...
internal fun advancedSettingsSections(): List<AdvancedSettingsSection> =
    listOf(
        ...
        AdvancedSettingsSection(
            rows = listOf(
                AdvancedSettingsRow(
                    titleRes = R.string.advanced_gemini_translation,
                    destination = AdvancedDestination.GeminiTranslation,
                    icon = AdvancedSettingsIcon.Translate,
                    subtitleRes = R.string.advanced_gemini_translation_subtitle,
                ),
                AdvancedSettingsRow(
                    titleRes = R.string.advanced_firebase,
                    destination = AdvancedDestination.Firebase,
                    icon = AdvancedSettingsIcon.Firebase,
                    subtitleRes = R.string.advanced_firebase_subtitle,
                ),
            ),
        ),
    )
...
private fun AdvancedSettingsIcon.imageVector(): ImageVector =
    when (this) {
        ...
        AdvancedSettingsIcon.Translate -> Icons.Rounded.Translate
        AdvancedSettingsIcon.Firebase -> Icons.Rounded.Cloud
    }
