...
import com.nhut.hoshi.features.anki.AnkiView
import com.nhut.hoshi.features.anki.AnkiHistoryView
import com.nhut.hoshi.features.bookshelf.BookshelfView
import com.nhut.hoshi.features.bookshelf.HoshiMainShell
import com.nhut.hoshi.features.bookshelf.MainTab
import com.nhut.hoshi.features.bookshelf.SasayakiMatchRequest
import com.nhut.hoshi.features.bookshelf.SettingsDestination
import com.nhut.hoshi.features.bookshelf.SettingsTab
import com.nhut.hoshi.features.diagnostics.DiagnosticsView
import com.nhut.hoshi.features.dictionary.DictionarySearchView
import com.nhut.hoshi.features.dictionary.DictionaryView
import com.nhut.hoshi.features.reader.ReaderAppearanceScreen
import com.nhut.hoshi.features.reader.ReaderBehaviorScreen
import com.nhut.hoshi.features.reader.ReaderFontManager
import com.nhut.hoshi.features.reader.ReaderSettings
import com.nhut.hoshi.features.sasayaki.SasayakiMatchView
import com.nhut.hoshi.features.sasayaki.SasayakiSettings
import com.nhut.hoshi.features.settings.AdvancedSettingsView
import com.nhut.hoshi.features.update.AboutScreen
        ...
        NavEntry(route) {
            when (route) {
                ...
                is AppRoute.SettingsDetailRoute -> SettingsDetailDestination(
                    ...
                    onSelectedTabChange = ::selectMainTab,
                    onOpenSettingsDetail = ::openSettingsDetail,
                )
...
private fun SettingsDetailDestination(
    ...
    onSelectedTabChange: (MainTab) -> Unit,
    onOpenSettingsDetail: (SettingsDetailSection) -> Unit,
) {
    when (route.section) {
        ...
        SettingsDetailSection.Anki -> AnkiView(
            onClose = onClose,
            onOpenHistory = { onOpenSettingsDetail(SettingsDetailSection.AnkiHistory) },
            modifier = Modifier.fillMaxSize(),
        )
        SettingsDetailSection.AnkiHistory -> AnkiHistoryView(
            onClose = onClose,
            modifier = Modifier.fillMaxSize(),
        )
